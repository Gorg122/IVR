...
//  });
   ...
   $('select[name=eme_mail_type]').change(updateShowMailTypes);
   updateShowMailTypes();
    ...
    $('#eventmail_startdate').datetimepicker({
	altField: '#eventmail_actualstartdate',
    ...
    $('#genericmail_startdate').datetimepicker({
	altField: '#genericmail_actualstartdate',
	altFieldTimeOnly: false,
	altFormat: 'yy-mm-dd',
	altTimeFormat: 'HH:mm:ss',
	dateFormat: eme.translate_dateformat,
	...
	showSecond: false
        ...
        jQuery('#MailingReportTableContainer').jtable({
            ...
            fields: {
                ...
                read_datetime: {
                    title: eme.translate_readdatetime,
                    searchable: false,
                    sorting: true
                },
                read_count: {
