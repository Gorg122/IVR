...
function updateShowHideRsvpMailSendMethod () {
   if (jQuery('select[name=eme_rsvp_mail_send_method]').val() == 'smtp') {
         ...
         jQuery('tr#eme_smtp_encryption_row').show(); 
         jQuery('tr#eme_smtp_debug_row').show(); 
         jQuery('tr#eme_smtp_verify_cert_row').show(); 
   } else {
         ...
         jQuery('tr#eme_smtp_encryption_row').hide(); 
         jQuery('tr#eme_smtp_debug_row').hide(); 
         jQuery('tr#eme_smtp_verify_cert_row').hide(); 
   }
}

function updateShowHideRsvpMailSMTPAuth () {
   if (jQuery('input[name=eme_rsvp_mail_SMTPAuth]').attr('checked') && jQuery('select[name=eme_rsvp_mail_send_method]').val() == 'smtp') {
         jQuery('tr#eme_smtp_username_row').show(); 
         jQuery('tr#eme_smtp_password_row').show(); 
   } else {
         jQuery('tr#eme_smtp_username_row').hide(); 
