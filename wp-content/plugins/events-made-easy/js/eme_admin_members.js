jQuery(document).ready(function ($) { 
	...
	$('#StoreQueryButton').click(function (e) {
           e.preventDefault();
	...
	$('#StoreQuerySubmitButton').click(function (e) {
           e.preventDefault();
	   var params = {
               'search_person': $('#search_person').val(),
               'search_status': $('#search_status').val(),
	...
	$('#StoreQueryDiv').hide();
        ...
        $('.eme_select2_status_class').select2({
		placeholder: eme.translate_selectstatus,
		width: '10%'
	});
		...
		placeholder: eme.translate_selectcustomfields,
		width: '10%'
	});
