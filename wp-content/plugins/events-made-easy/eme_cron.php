...
function eme_cron_send_new_events_function() {
   ...
   $mail_subject=eme_get_template_format(get_option('eme_cron_new_events_subject'),0);
   $header=eme_get_template_format(get_option('eme_cron_new_events_header'),0);
   $entry=eme_get_template_format(get_option('eme_cron_new_events_entry'),0);
   $footer=eme_get_template_format(get_option('eme_cron_new_events_footer'),0);
